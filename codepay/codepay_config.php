...
define('DB_PWD', '资源！！部zi！！yuanbu.com');//数据库密码
define('DB_NAME', 'yu91g');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'user');  //充值用户所在数据库表名
